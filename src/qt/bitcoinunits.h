...
#ifndef BZX_QT_BZXUNITS_H
#define BZX_QT_BZXUNITS_H
...
*/
class BZXUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BZXUnits(QObject *parent);

    /** BZX units.
      @note Source: https://en.BZX.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef BZXUnits::Unit BZXUnit;

#endif // BZX_QT_BZXUNITS_H
