    ...
    mapper(0)
{
    ...
    ui->BZXAtStartup->setToolTip(ui->BZXAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->BZXAtStartup->setText(ui->BZXAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BZXUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->BZXAtStartup, OptionsModel::StartAtStartup);
