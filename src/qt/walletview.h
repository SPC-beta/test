...
#ifndef BZX_QT_WALLETVIEW_H
#define BZX_QT_WALLETVIEW_H
...
public Q_SLOTS:
    ...
    /** Switch specifically to BZX tx history tab */
    void gotoBZXHistoryTab();
    /** Switch to BZX tx history tab and focus on specific transaction */
    void focusBZXHistoryTab(const QModelIndex &idx);
