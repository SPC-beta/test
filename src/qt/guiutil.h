...
#ifndef BZX_QT_GUIUTIL_H
#define BZX_QT_GUIUTIL_H
...
/** Utility functions used by the BZX Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "BZX:" URI into recipient object, return true on successful parsing
