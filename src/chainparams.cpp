...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("51.91.156.251", "51.91.156.251", true));
        vSeeds.push_back(CDNSSeedData("51.91.156.249", "51.91.156.249", true));
        vSeeds.push_back(CDNSSeedData("bzx.pool4u.net:29149","bzx.pool4u.net:29149", true));
